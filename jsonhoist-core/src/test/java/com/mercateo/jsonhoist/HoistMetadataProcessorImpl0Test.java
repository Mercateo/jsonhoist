...
public class HoistMetadataProcessorImpl0Test {
    ...
    public void testVersionInfo() {
        ...
        assertEquals(WithVersionInfo.class.getSimpleName(), uut.extract(WithVersionInfo.class)
                .getType());
    }
    ...
    public void testExtractJsonNodeWithFallbackTypeAndVersion() throws Exception {
        HoistMetaData extract = uut.extract(new ObjectNode(new ObjectMapper().getNodeFactory()), uut
                .extract(WithVersionInfoAndType.class));
    ...
    public void testExtractJsonNodeWithVersion() throws Exception {
        ...
        HoistMetaData extract = uut.extract(doc, uut
                .extract(WithVersionInfoAndType.class));
